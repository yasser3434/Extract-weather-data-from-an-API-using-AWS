...
transform_task = GlueJobOperator(
    ...
    script_location='s3://glue-assets-eu-west-3/scripts/transform.py',
    s3_bucket='s3://aws-glue-assets-eu-west-3',  
    aws_conn_id='AWS_CONN', 
    region_name="eu-west-3",
    iam_role_name='mwaa-environment-public-network-RedshiftIamRole-3DehPkxzxkgb',
